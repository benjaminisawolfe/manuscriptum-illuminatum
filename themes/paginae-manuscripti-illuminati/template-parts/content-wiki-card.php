...
<article <?php post_class( 'manuscriptum-illuminatum-card manuscriptum-illuminatum-card--wiki' ); ?>>
	...
	<div class="manuscriptum-illuminatum-card__body">
		...
		<p><?php echo esc_html( wp_trim_words( $summary ? $summary : get_the_excerpt(), 30 ) ); ?></p>
	</div>
</article>
